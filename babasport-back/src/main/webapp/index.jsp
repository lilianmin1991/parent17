...
<h1 class="logo"><a href="index.jsp"><img src="images/logo.png" alt="Great Tilly" /></a></h1>
</div><!-- logo -->
...
<ul>
<li><a href="index.jsp">主页 Version 1</a></li>
<li><a href="index-2.jsp">主页 Version 2</a></li>
<li><a href="index-3.jsp">主页 Version 3</a></li>
<li><a href="index-4.jsp">主页 Version 4</a></li>
<li><a href="index-5.jsp">主页 Version 5</a></li>
<li><a href="index-6.jsp">主页 Version 6</a></li><li><a href="http://www.17sucai.com">More</a></li>
</ul>
</li>
...
<div class="separator"></div>
				...
				<div class="four columns">
					...
					<div class="service">
						...
						<h3 class="centered"><a href="#" class="dark-link">智能聊天机器人</a></h3>
						<p class="centered">
				...
				<div class="four columns">
					...
					<div class="service">
						...
						<h3 class="centered"><a href="#" class="dark-link">个人博客</a></h3>
						<p class="centered">
				...
				<div class="four columns">
					...
					<div class="service">
						...
						<h3 class="centered"><a href="#" class="dark-link">大数据</a></h3>
						<p class="centered">
				...
				<div class="four columns">
					<!-- Icon Box -->
					<div class="service">
						<a href="http://39.105.85.33:8081/control/index.do"  target="_blank"><i class="fa fa-magic colored square"></i></a>
						<h3 class="centered"><a href="http://39.105.85.33:8081/control/index.do"  target="_blank" class="dark-link">电商项目</a></h3>
						<p class="centered">
...
<div class="tooltips">			
	...
	<p>Copyright &copy; 2018 <a href="#">alphawd</a>. More Templates <a href="#" target="_blank" title="Great Tilly">Great Tilly</a> - Collect from <a href="#" title="Great Tilly" target="_blank">Great Tilly</a>.</p>
	</div>
	<div class="eight columns">
