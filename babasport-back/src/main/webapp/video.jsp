	...
	<div class="twelve columns">
                ...
                <div>
                	...
                	<div class="entry-video">
                		<iframe src="http://player.vimeo.com/video/47800751?title=0&byline=0&color=b9ed4a" width="700" height="350" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                    </div>
                </div>
                <!-- end vimeo video -->
                ...
                <div>
                	<h2>YouTube Video</h2>
                    <div class="entry-video">
                        <iframe width="700" height="394" src="http://www.youtube.com/embed/jWxuY4SYtaA?rel=0" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
                <!-- end youtube video -->
