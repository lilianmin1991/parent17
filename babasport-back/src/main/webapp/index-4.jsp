...
<div class="container">
    ...
    <div class="separator"></div>
				...
				<div class="four columns">
					<!-- Icon Box -->
					<div class="service">
						<a href="#"><i class="fa fa-shopping-cart colored square"></i></a>
				...
				<div class="four columns">
					<!-- Icon Box -->
					<div class="service">
						<a href="#"><i class="fa fa-code-fork colored square"></i></a>
				...
				<div class="four columns">
					<!-- Icon Box -->
					<div class="service">
						<a href="#"><i class="fa fa-plane colored square"></i></a>
				...
				<div class="four columns">
					<!-- Icon Box -->
					<div class="service">
						<a href="#"><i class="fa fa-camera-retro colored square"></i></a>
...
<div class="twelve columns">
<h4 class="headline">Latest From The Blog</h4>
...
<h6>
<a href="#">Post With Image Slider</a>
</h6>
<p class="info">
February 28, 2013,
<a href="#">0 Comments</a>
...
<iframe src="http://player.vimeo.com/video/47800751?title=0&byline=0&color=b9ed4a" width="100%" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
...
<div class="four columns">
<h4 class="headline">What Clients Say</h4>
				<!-- Testimonial -->
                <blockquote class="speech-bubble">
                    <div class="quote-content">
                        <p> Maecenas lacus aliquet et nisl nunc, per sed sed maecenas.Lectus tincidunt pellentesque augue urna sit sed, arcu sed ante ac montes. </p>
                        <span class="quote-arrow"></span>
                    </div>
                    <div class="quote-meta"> John Doe, Developer<br>
