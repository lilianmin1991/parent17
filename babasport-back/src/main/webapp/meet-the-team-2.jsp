...
<div class="container">
  ...
  <div class="sixteen columns">
	...
	<p style="text-align:center; margin-bottom:40px; font-size:15px;">
	Our services offering ranges from UX design to e-commerce setups <br />
    Just check out all of the service lists below to get a 
	</p>
  </div>
  
	    <div class="four columns team">
		  <img src="images/team/member1.jpg" alt="member" /> 
          <h3>Jessica Doe</h3>
		  <div class="email">jessica@mail.com</div>
		  <p>
          Ut libero nibh, viverra at faucibus at, posuere non tortor. Suspendisse potenti. Sed et nulla eu est eleifend porta. Ut lobortis nisi nec nisi tempor iaculis. Mauris leo elit.
		  </p>
		  <div class="tooltips">	
		  <ul class="social">
	    ...
	    <div class="four columns team">
		  <img src="images/team/member2.jpg" alt="member" /> 
          <h3>Mike Doe</h3>
		  <div class="email">mike@mail.com</div>
		  <p>
          Ut libero nibh, viverra at faucibus at, posuere non tortor. Suspendisse potenti. Sed et nulla eu est eleifend porta. Ut lobortis nisi nec nisi tempor iaculis. Mauris leo elit.
		  </p>
		  <div class="tooltips">	
	    ...
	    <div class="four columns team">
		  <img src="images/team/member3.jpg" alt="member" /> 
          <h3>John Doe</h3>
		  <div class="email">john@mail.com</div>
		  <p>
          Ut libero nibh, viverra at faucibus at, posuere non tortor. Suspendisse potenti. Sed et nulla eu est eleifend porta. Ut lobortis nisi nec nisi tempor iaculis. Mauris leo elit.
		  </p>
		  <div class="tooltips">	
	    ...
	    <div class="four columns team">
		  <img src="images/team/member4.jpg" alt="member" /> 
          <h3>Laura Doe</h3>
		  <div class="email">laura@mail.com</div>
		  <p>
          Ut libero nibh, viverra at faucibus at, posuere non tortor. Suspendisse potenti. Sed et nulla eu est eleifend porta. Ut lobortis nisi nec nisi tempor iaculis. Mauris leo elit.
		  </p>
		  <div class="tooltips">	
...
<div class="separator"></div>
        ...
        <div class="sixteen columns" style="text-align:center;">
            <a href="#" class="btn colored">Join the Team</a>
		    <a href="blog-post.jsp" class="btn colored">Browse Work</a>
        </div>
...
<div class="separator"></div>
        ...
        <div class="sixteen columns">
        <h2 style="text-align:center;">Our area of expertise</h2>
        </div>
...
<div class="separator"></div>
				...
				<div class="one-third column">
					...
					<div class="icon-box medium">
						<i class="fa fa-html5 medium colored"></i>
				...
				<div class="one-third column">
					...
					<div class="icon-box medium">
						...
						<h4><a href="#" class="dark-link">Tation Dipiscing Elit</a></h4>
						<p>Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim.</p>
					</div>
					<!-- End Icon Box -->
				</div>			
