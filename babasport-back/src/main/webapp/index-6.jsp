...
<div class="clearfix"></div>
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="eight columns">
        <img style="margin-top:10px;" src="images/responsive.png" alt="responsive" />
      </div>

      <div class="eight columns">
        <h3 style="margin-top:20px;">Find More about our Features</h3>
        <p>
        Nam tortor ligula, adipiscing non pretium sed, scelerisque eget est. Etiam nec lla rutrum, venenatis libero non, aliquam orci. Phasellus tristique nunc at plat mollis. Etiam sollicitudin facilisis condimentum.
        </p>
  ...
  <div class="wrapper" style="padding-bottom:0!important;">
    <div class="container">
      ...
      <div class="sixteen columns">
        <h3 style="margin-top:; text-align:center;">Check our Portfolio to know more about our works</h3>
		<p style="text-align:center;">
        Cras et leo mi, nec fermentum eros. Nullam molestie ultricies tellus id viverra. Quisque porttitor dapibus nulla a consequat. Donec vitae mauris.
		</p>
	  </div>
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="sixteen columns">
        <h3 style="margin-top:; text-align:center;">Our Clients</h3>
		<p style="text-align:center;">
        Quisque porttitor dapibus nulla a consequat. Donec vitae mauris.
		</p>
	  </div>
