...
<h3 class="name" style="margin:0;">John Doe</h3>
<h6 style="text-transform:none; font-family: 'OpenSansRegular'; color: #999999; display: block; margin-bottom: 10px;">Web Designer</h6>
</div>

<div class="eight columns">
<img class="photo" src="images/about/about-me.jpg" alt="Team Member">
</div>

<div class="eight columns">
<p>
In at odio id dui vulputate sodales nec at arcu. Nullam eu dolor ut nulla feugiat dapibus at ornare nulla. Curabitur sed justo purus. Etiam velit leo, condimentum at bibendum consectetur, luctus eu dui. Donec lacinia, leo vel pulvinar tempor, nisl dolor fringilla enim, eu condimentum est nunc eget felis.
</p>
</p>
Ut libero nibh, viverra at faucibus at, posuere non tortor. Suspendisse potenti. Sed et nulla eu est eleifend porta. Ut lobortis nisi nec nisi tempor iaculis. Mauris leo elit, luctus et ullamcorper eget, hendrerit vel nulla. Suspendisse ullamcorper erat nec turpis tempor luctus. Duis gravida posuere blandit. Nulla in metus orci, non adipiscing ante. Nulla non pellentesque neque. Cras rutrum semper odio, vel eleifend diam suscipit at.
</p>

<i class="fa fa-envelope"></i><a href="mailto:john.doe@website.com" style="color:#04BFEA; margin-left:10px;">john.doe@website.com</a> <br>
<i class="fa fa-phone"></i><span style="color:#04BFEA; margin-left:10px;">+1 (229) 991-22-11</span>
				<div class="tooltips" style="margin-top:5px;">			
			    <ul class="social">
				...
				<li><a href="#" data-rel="tooltip" title="Skype"><i class="fa fa-skype"></i></a></li>
			    </ul>
                </div>
</div>
...
<div class="separator"></div>
        ...
        <div class="sixteen columns">
        <h2 style="text-align:center;">My area of expertise</h2>
        </div>
