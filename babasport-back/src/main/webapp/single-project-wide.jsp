...
<h3> <span>Single Project Wide</span> </h3>
</div>
...
<div class="sixteen columns single-project">
            ...
            <!-- End Image -->
				...
				<div class="twelve columns">
					<!-- Project Description -->
					<div class="title">
						<h4 class="lined">Project Description</h4>
					</div>
					<p>
					...
					<!-- Social Buttons -->
					<ul class="social m-varicolored">
						<li><a class="fb" href="#"><i class="fa fa-facebook"></i></a></li>
						<li><a class="tw" href="#"><i class="fa fa-twitter"></i></a></li>
						<li><a class="pt" href="#"><i class="fa fa-pinterest"></i></a></li>
						<li><a class="lin" href="#"><i class="fa fa-linkedin"></i></a></li>
						<li><a class="gl" href="#"><i class="fa fa-google-plus"></i></a></li>
					</ul>
					<!-- End Social Buttons -->
				...
				<div class="four columns">
					<!-- Project Details -->
					<div class="title">
						<h4 class="lined">Project Details</h4>
					</div>
					<ul class="list">
						<li><strong>Client: </strong>Company Name</li>
						<li><strong>Date: </strong>July 23, 2013</li>
						<li><strong>Tags: </strong>Logo, Web Design</li>
					</ul>
					<!-- Live Preview Button -->
					<p>
						<a href="#" class="btn colored">Live Preview<i class="fa fa-chevron-circle-right" style="margin: 0 0 0 7px;"></i></a>
					</p>
			...
			<div class="sixteen columns">
				<h4 class="headline">Related Projects</h4>
			</div>
				...
				<div class="four columns">
					<div class="work">
						<a href="../../player.vimeo.com/video/67500403@badge=0" data-gal="prettyPhoto" class="work-image">
