...
<h3> <span>Portfolio 4 Columns</span> </h3>
</div>
...
<div class="container">
			...
			<div class="row port works">
				<div class="row-item four columns identity photography tehnology">
					<div class="work">
				...
				<div class="row-item four columns photography webdesign">
					<div class="work">
				...
				<div class="row-item four columns identity">
					<div class="work">
				...
				<div class="row-item four columns tehnology">
					<div class="work">
						...
						<a href="#" class="work-name">Surfing</a>
						<div class="tags">
							Tehnology
						</div>
					</div>
				</div>				
				<div class="row-item four columns photography webdesign identity">
					<div class="work">
						<a href="../../vimeo.com/67500403" data-gal="prettyPhoto" class="work-image">
						<img src="images/portfolio/santorini.jpg" alt="">
						<div class="link-overlay fa fa-play">
						</div>
						</a>
						<a href="#" class="work-name">Santorini</a>
						<div class="tags">
							Webdesign Identity
						</div>
					</div>
				...
				<div class="row-item four columns tehnology">
					<div class="work">
						...
						<img src="images/portfolio/climbing.jpg" alt="">
						<div class="link-overlay fa fa-chevron-right">
						</div>
						</a>
						<a href="#" class="work-name">Climbing</a>
						<div class="tags">
							Tehnology
						</div>
					</div>
				</div>				
				<div class="row-item four columns photography tehnology identity">
					<div class="work">
						<a href="images/portfolio/flowers-big.jpg" data-gal="prettyPhoto" class="work-image">
						<img src="images/portfolio/flowers.jpg" alt="">
						<div class="link-overlay fa fa-search">
						</div>
						</a>
						<a href="#" class="work-name">Flowers</a>
						<div class="tags">
							Tehnology Identity
						</div>
					</div>
				</div>				
				<div class="row-item four columns webdesign">
					<div class="work">
						<a href="#" class="work-image">
						<img src="images/portfolio/dreaming.jpg" alt="">
						<div class="link-overlay fa fa-chevron-right">
						</div>
						</a>
						<a href="#" class="work-name">Dreaming</a>
						<div class="tags">
							Web Design
						</div>
					</div>
