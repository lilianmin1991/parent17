...
<div class="w loc">
	<div class="h-title">
	    ...
	    <div class="h-search">
	        ...
	        <div class="h-se-btn"><a href="javascript:;" onclick="serachKeyword()">搜索</a></div>
	    </div>
	</div>
		...
		<h2 class="h2 h2_filter mt"><em title="商品筛选">商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			<ul class="uls filter">
				...
				<li><b>价格：</b><p>
					...
					<a href="javascript:void(0);" title="200-499" onclick="fqPrice('200')">600以上</a>
				</p></li>
				</c:if>
				<li><b>类型：</b><p>
					<a href="javascript:void(0);" title="不限" class="here">不限</a>
			...
			<div class="mt ofc">
				...
				<c:forEach items="${pagination.list }" var="product">
					<li>
						<a href="javascript:;" onclick="window.open('/product/detail.shtml?id=${product.id}')" title="瑜伽服"  class="pic"><img src="${product.img.allUrl }" alt="瑜伽服" /></a>
						<dl>
							<!-- dt 10个文字+... -->
							<dt><a href="javascript:;" onclick="window.open('http://localhost:8083/html/product/${product.id}.html')" title="依琦莲2014瑜伽服套装新款" >${product.name }</a></dt>
							<!-- dt 25个文字+... -->
